package com.sergiodeiscar.sudoku.view.custom
        ...
        cells?.forEach {
            ...
            if(value == 0){
                it.notes.forEach { note ->
                    ...
                    canvas.drawText(
                        valueString,
                        (it.col * cellSizePixels) + (colInCell * noteSize) + noteSize / 2 - textWidth / 2,
                        (it.row * cellSizePixels) + (rowInCell * noteSize) + noteSize / 2 + textHeight / 2,
                        noteTextPaint
                    )
                }
            }else{
